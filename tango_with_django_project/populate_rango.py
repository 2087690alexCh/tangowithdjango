...
def populate():
    ...
    me_cat = add_cat(name="Alex Chilikov", views=5, likes=5)

    add_page(cat=me_cat, title="GitHub", url="https://github.com/2087690alexCh/")

    add_page(cat=me_cat, title="Pythonanywhere", url="https://www.pythonanywhere.com/user/2087690alexCh/consoles/")
